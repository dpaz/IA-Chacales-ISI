...
var Tablero = function(id_game, npiezas, piezas){
	...
	this.posiblelugar= function(pieza){
	 ...
	 this.coloco = function(pieza,x,y){
		...
		var dummyU = this.piezaenposiciones(x,y+1)	//AQUÃ EXPLOTA PREGUNTAR A PEDRO
		...
		if((dummyU!=undefined)&&(dummyU.Abajo!=pieza.Arriba)){comparo = false}	//algï¿½n conflicto; false
