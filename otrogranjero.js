...
compruebaCampo = function(pieza,posSeg){
	if(pieza.tipo == 'MonCamino' || pieza.tipo =='MonGranja'|| pieza.tipo =='CiudadE' ||
	   ...
	   pieza.tipo=='CiudadT'){
		  ...
		  pieza.tipo == 'Recto' || pieza.tipo == 'Cruce3')&& (posSeg==1 || posSeg==2 || posSeg==3)){
			return true;				
		...
		return true;
	}else if((pieza.tipo == 'Cruce3') && (PosSeg==1 || PosSeg==2 || PosSeg==3)){
		return true;
	}return false;
...
////////////////cuidado monCamino recursividad
	if(pieza.Arriba != 'Ciudad' && vengode !='Arriba' && aux.Abajo != 'Ciudad'){
		...
		if(aux.tipo == 'CiudadF' || aux.tipo =='CiudadG'|| aux.tipo =='CiudadQ' || aux.tipo =='CiudadR'){//cierra con estos 
			...
			if(aux.Abajo == 'Granja' && pieza.Arriba == 'Granja' && compruebaCampo(pieza,posSeg)){
...
//comprueba que el seguidor que quiero poner se comunica con el campo de abajo
compruebaCampo2 = function(pieza,posSeg){
	if(pieza.tipo == 'MonCamino' || pieza.tipo =='MonGranja'|| pieza.tipo =='CiudadE' ||
           pieza.tipo == 'CiudadH' || pieza.tipo =='CiudadI'|| pieza.tipo == 'CiudadM'||	 				      		   pieza.tipo=='CiudadN'|| pieza.tipo == 'CiudadQ' || pieza.tipo== 'CiudadR' ||
	   pieza.tipo=='CiudadD'|| pieza.tipo == 'CiudadJ' || pieza.tipo== 'CiudadK' ||
	   pieza.tipo=='CiudadO'|| pieza.tipo == 'CiudadP' || pieza.tipo== 'CiudadS' ||
	   pieza.tipo=='CiudadT'){
		  ...
		  pieza.tipo == 'Recto' || pieza.tipo == 'Cruce3') && (pieza.Abajo =='Granja') && 
		 (posSeg==7 || posSeg==8 || posSeg==9)){
			return true;				
	}else if((pieza.tipo == 'CiudadJ') &&  (PosSeg!=3)){
		return true;
	}else if((pieza.tipo == 'CiudadK') &&  (PosSeg!=1)){
		return true;
	}else if((pieza.tipo == 'Curva') &&  (pieza.Izquierda=='Camino') && (PosSeg!=1)){
		return true;
	}else if((pieza.tipo == 'Curva') &&  (pieza.Derecha=='Camino') && (PosSeg!=3)){
		return true;
	}else if((pieza.tipo == 'Cruce3') && (PosSeg==7 || PosSeg==8 || PosSeg==9)){
		return true;
	}return false;
